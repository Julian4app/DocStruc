-- ============================================================================
-- CRITICAL SECURITY FIX: Enable RLS on CRM/Admin tables (CORRECTED v3)
-- Date: 2025-02-19 (FIXED)
-- Description: These CRM/admin tables were being accessed without RLS.
--              This version accounts for ACTUAL schema structure.
--
-- NOTE: projects, tasks, project_members already have proper RLS from:
--   - 20260215_complete_rls_overhaul.sql (has_project_access)
--   - 20260217_fix_project_access_for_teams.sql (superuser + team)
--   - 20260217_002_implement_content_visibility_rls.sql (visibility)
-- DO NOT add duplicate policies for those tables!
-- 
...
--   - invoices has company_id (CRM invoices), NOT project_id
-- ============================================================================

-- ============================================================================
-- 1. COMPANIES — CRM data (Admin system)
-- ============================================================================
