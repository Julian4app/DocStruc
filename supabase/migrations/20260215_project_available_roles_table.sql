...
DROP TABLE IF EXISTS project_available_roles;

-- Create project_available_roles junction table
...
CREATE INDEX IF NOT EXISTS idx_project_available_roles_project_id ON project_available_roles(project_id);
CREATE INDEX IF NOT EXISTS idx_project_available_roles_role_id ON project_available_roles(role_id);
